...
class AverageSummeryGraph extends StatefulWidget {
   AverageSummeryGraph({super.key, required this.divs, required this.selectedEstateiD, required this.selectedEstate, required this.width,      required this.isFullScreen});
    List<DivData> divs;
  ...
  @override
  State<AverageSummeryGraph> createState() => _AverageSummeryGraphState();
}

class _AverageSummeryGraphState extends State<AverageSummeryGraph> {
    double avg = 0;
              ...
              children: [
                Expanded(
                  child: Align(
                    ...
                    child: Text(
                                      "Average Summary - ${widget.selectedEstate??""}",
                      style: TextStyle(
    ...
    minorGridLines: MinorGridLines(width: 0), // Removes minor Y-axis grid lines
     plotBands: avg != 0
                    ...
                    : [], 
                                    ...
                                    palette: const <Color>[
                                      Color.fromARGB(255, 225, 38, 235),
                                      Color.fromARGB(255, 93, 215, 40),
                                    ],
